...
test("renders title and author but not url and likes", () => {
  ...
  expect(blogDiv).toHaveTextContent("The blog title");
  expect(blogDiv).toHaveTextContent("The blog author");
  expect(blogDiv).not.toHaveTextContent("https://www.theblog.com");
...
test("renders url and likes on button click", async () => {
  ...
  expect(blogDiv).toHaveTextContent("https://www.theblog.com");
